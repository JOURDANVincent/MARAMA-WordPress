...
function bizberg_consulting_dark_featured_title_subtitle(){
...
add_action( 'bizberg_before_homepage_blog', 'bizberg_consulting_dark_featured_posts' );
function bizberg_consulting_dark_featured_posts(){
            ...
            <div class="consulting-post-outer">
            	<div class="row">
            		<div class="col-lg-12 col-md-12 col-xs-12 title_subtitle_wrapper">
            			<?php 
            			$title_subtitle = bizberg_consulting_dark_featured_title_subtitle();
            	...
            	if( $featured_query->have_posts() ): ?>
            		...
            		<div class="row">
	            		...
	            		while( $featured_query->have_posts() ): $featured_query->the_post();
		                    ...
		                    <div class="<?php bizberg_consulting_dark_featured_col( $columns ); ?> mb-3">
...
function bizberg_consulting_dark_featured_col( $col ){
